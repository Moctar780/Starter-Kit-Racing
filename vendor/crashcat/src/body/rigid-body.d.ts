...
import { type GetLeafShapeResult, type GetSubShapeTransformedShapeResult, type Shape } from '../shapes/shapes';
import type { World } from '../world';
import { type BodyId } from './body-id';
 ...
 */
export declare function updatePositionFromCenterOfMass(body: RigidBody): void;
