...
export declare const DEFAULT_SHAPE_DENSITY = 1000;
...
export declare function createSupportingFaceResult(): SupportingFaceResult;
...
export type GetSupportFunctionImpl<S extends ShapeBase> = (pool: any, shape: S, mode: SupportFunctionMode, scale: Vec3) => any | undefined;
...
export declare const collisionDispatch: CollisionDispatch;
/**
 ...
 */
export declare function setCollideShapeFn(typeA: ShapeType, typeB: ShapeType, fn: CollideShapeVsShapeFn): void;
/**
 ...
 */
export declare function setCastShapeFn(typeA: ShapeType, typeB: ShapeType, fn: CastShapeVsShapeFn): void;
export declare function getShapeSurfaceNormal(out: Vec3, shape: Shape, position: Vec3, subShapeId: number): Vec3;
export declare function computeMassProperties(out: MassProperties, shape: Shape): MassProperties;
/**
 ...
 */
export declare function getShapeSupportingFace(out: Face, shape: Shape, subShapeId: number, localDirection: Vec3, transform: Mat4, scale: Vec3): void;
/**
 ...
 */
export declare function getShapeInnerRadius(shape: Shape): number;
export {};
